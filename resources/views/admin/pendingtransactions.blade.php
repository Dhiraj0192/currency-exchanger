...
<div class="bodycontainer">
    <div class="header-section">
        <h2 class="header-title">Pending Transactions</h2>
           ...
           <tr class="movies-info-heading">
            ...
            <tr class="movies-info-heading-data">
              <div class="movies-data-container">
                ...
                <td><p class="review-data">{{$data->Amount}} INR</p></td>
                <td><p class="review-data">{{$data->ReceiveAmount}} USDT</p></td>
                <td><p class="review-data">{{$data->Address}}</p></td>
                
                <td><p class="review-data" style="color: red;">{{$data->Status}}</p></td>
                
                <!-- <td><p class="status-data"></p></td> -->
                <td style="text-align: right;">
                  <div class="action-container">
                    
                    <a href="{{ url('transaction',['id' => $data->id])}}"><i class='bx bxs-low-vision eye-icon'></i></a>
