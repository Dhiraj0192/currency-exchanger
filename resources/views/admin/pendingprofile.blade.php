...
<head>
    ...
    <title>XetoXchage - Pending Users</title>
...
<body>
    <div class="sidebar-container">
        ...
        <div class="navbar-container">
            ...
            <a href="{{url('/pending-user')}}" class="nav-link"><i class='bx bx-movie'></i><span class="nav-active">Pending Users</span></a>
...
<div class="bodycontainer">
    <div class="header-section">
        <h2 class="header-title">Pending Users</h2>
