...
<head>
    ...
    <title>XetoXchage - Admin Users</title>
      ...
      <div class="user-container">
          ...
          <table class="spacing">
           <tr class="movies-info-heading">
            ...
            @foreach($adminuser as $key => $data)
          
            <tr class="movies-info-heading-data">
              <div class="movies-data-container">
                <td><p class="id-data">{{$data->id}}</p></td>
                <td>
                  <div class="info-container">
                    <img src="{{ asset('images/AdminProfilePicture/' . $data->profileImage) }}" class="user-image-data">
                    
                  </div>
                </td>
                <td style=" letter-spacing: 1px"><p class="comment-data">{{$data->fullname}}</p></td>
                <td><p class="review-data">{{$data->email}}</p></td>
                <td><p class="status-data">{{$data->number}}</p></td>
